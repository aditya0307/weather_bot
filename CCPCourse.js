...
function customerInformation() {
    document.getElementById("customername").value = "response";
      ...
      document.getElementById("customerid").value = "response";
      document.getElementById("lastcalled").value = "response";
      document.getElementById("reason").value = "response";
      document.getElementById("transferred").value = "response";
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://75ukomvbcg.execute-api.us-east-1.amazonaws.com/DEV",
      "method": "GET",
      "headers": {
        "name": "customerNumber"
      }
...
function loadCCP() {
    ...
    var ccpUrl = "https://capabilitynetwork-assets.awsapps.com/connect/ccp#/";
